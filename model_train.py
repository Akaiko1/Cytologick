...
if __name__ == '__main__':
    ...
    if str(cfg.FRAMEWORK).lower() == 'pytorch':
        ...
        if resume_path:
            ...
            ai.train_current_model_pytorch(cfg, resume_path, 200, batch_size=32, save_base_path=model_path)
        else:
            print(f'Training new model, will save to {model_path}')
            ai.train_new_model_pytorch(cfg, model_path, cfg.CLASSES, epochs=50, batch_size=32)
    else:
